...
#ifndef _XCC_TEST_TPL___PARAM_EVALUATION_CHECK_HPP_
#define _XCC_TEST_TPL___PARAM_EVALUATION_CHECK_HPP_
...
class test_ObjReference_Refcounter
{
	...
	public: test_ObjReference_Refcounter(TPL_OBJ_TYPE* psh_obj) noexcept
	{
