#ifndef _XC_SI_TEST_INT_ADD_HPP_
#define _XC_SI_TEST_INT_ADD_HPP_
...
) noexcept
{
	...
	if(1)
	{
		do
		{
			...
			xcc_test2_case_descr("add+1.1.0-zeros", "");
	...
	if(1)
	{
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-overflow.1.a", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-overflow.1.b", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-overflow.2.a", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-overflow.2.b", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-overflow.10.a", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-overflow.10.b", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-overflow.10.c", "");
	...
	if(1)
	{
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-underflow.1.a", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-underflow.1.b", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-underflow.2.a", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-underflow.2.b", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-underflow.10.a", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-underflow.10.b", "");
		...
		do
		{
			...
			xcc_test2_case_descr("add+1.error.1-underflow.10.c", "");
