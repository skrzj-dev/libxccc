...
{
	xcc_test2_scope("xc_cmem_s : param evaluation check");
	...
	do
	{
		...
		if(1)
		{
			xc_mem_s_allocz_bytes( eval_bytesize.get_val() );
		}
	...
	do
	{
		...
		if(1)
		{
			xc_mem_s_allocz_obj_array( int, eval_arraysize.get_val() );
		}
	...
	do
	{
		...
		if(1)
		{
			xc_mem_s_cp_bytes( eval_arraysize.get_val(), eval_targetp.get_refp(), eval_srcp.get_refp() );
		}
	...
	do
	{
		...
		if(1)
		{
			xc_mem_s_cp_obj( int, eval_targetp.get_refp(), eval_srcp.get_refp() );
		}
	...
	do
	{
		...
		if(1)
		{
			xc_mem_s_cp_obj_array( int, eval_arraysize.get_val(), eval_targetp.get_refp(), eval_srcp.get_refp() );
		}
	...
	if(1)
	{
		do
		{
			...
			if(1)
			{
				xc_mem_s_cmp_bytes_param( eval_bytesize.get_val(), eval_targetp.get_refp(), eval_srcp.get_refp(), eval_result.get_refp() );
			}
		...
		do
		{
			...
			if(1)
			{
				xc_mem_s_cmp_obj_param( int, eval_targetp.get_refp(), eval_srcp.get_refp(), eval_result.get_refp() );
			}
		...
		do
		{
			...
			if(1)
			{
				xc_mem_s_cmp_obj_array_param( int, eval_arraysize.get_val(), eval_targetp.get_refp(), eval_srcp.get_refp(), eval_result.get_refp() );
			}
	...
	if(1)
	{
		do
		{
			...
			if(1)
			{
				int result=xc_mem_s_cmp_bytes( eval_bytesize.get_val(), eval_targetp.get_refp(), eval_srcp.get_refp() );
			}
		...
		do
		{
			...
			if(1)
			{
				int result=xc_mem_s_cmp_obj( int, eval_targetp.get_refp(), eval_srcp.get_refp() );
			}
		...
		do
		{
			...
			if(1)
			{
				int result=xc_mem_s_cmp_obj_array( int, eval_arraysize.get_val(), eval_targetp.get_refp(), eval_srcp.get_refp() );
			}
