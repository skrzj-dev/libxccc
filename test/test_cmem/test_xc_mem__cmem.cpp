...
#include "test_xc_mem_intf__cmem.h"

#include "test_xc_mem__cmem_code_inc.hpp"

#include "test_xc_mem__cmem.hpp"

static int test_xc_mem_do_all(xcc_test2_param_list) noexcept;

static int test_xc_mem_do_all(xcc_test2_param_list) noexcept
{
	xcc_test2_scope("[test xc_mem]");
...
int test_xc_mem(xcc_test2_param_list) noexcept
{
	
	return test_xc_mem_do_all(xcc_test2_param_list_forward);
}
