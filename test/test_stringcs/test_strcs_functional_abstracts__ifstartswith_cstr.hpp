...
#ifndef _TEST_STRINGCS_ABSTRACTS_ifStartsWithCstr_HPP_
#define _TEST_STRINGCS_ABSTRACTS_ifStartsWithCstr_HPP_
/* --- */
...
class subtest_ifStartsWithCstr_tplt: public test_xcStringS_testStaticStr_sub_I<TPL_STROBJ>
{
	...
	public: typedef xcc_test3_DATAROW5_DECLT(
		...
		, testParamValued01<TPL_STROBJ>
		, int
	) test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t;
	protected: int test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv(
	...
	public: typedef xcc_test3_DATAROW4_DECLT(
		...
		, testParamValued01<TPL_STROBJ>
		, int
	) test_ifStartsWithCstr_againstItself_expectRetv_paramRow_t;
	protected: int test_ifStartsWithCstr_againstItself_expectRetv(
		  xcc_test2_failureDetails_t* failInfo
		, test_xcStringS_I_abstract<TPL_STROBJ>* strIntf
		, testParamValued01<TPL_STROBJ> self
		, int resultval
	...
	public: subtest_ifStartsWithCstr_tplt(
	...
	protected: int test_ifStartsWithCstr_ANYCASE(xcc_test2_param_list)
	{
		xcc_test2_scope("[CSTRD]-[ifStartsWithCstr]");
		...
		if(1)
		{
			test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t rows[]=
			{
				  xcc_test3_DATAROW5_ITZ_T(test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t, "var1"
					, refp_failReport, intfs->INTF_STATICSTR
					, intfs->INTF_SET->strcsNull->value(), intfs->INTF_SET->strcsNull->value(), 0
				)
				, xcc_test3_DATAROW5_ITZ_T(test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t, "var2"
					, refp_failReport, intfs->INTF_STATICSTR
					, intfs->INTF_SET->strcsNull->value(), intfs->INTF_SET->strcsUninitZero->value(), 0
				)
				, xcc_test3_DATAROW5_ITZ_T(test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t, "var3"
					, refp_failReport, intfs->INTF_STATICSTR
					, intfs->INTF_SET->strcsNull->value(), intfs->INTF_SET->strcsUninitNonZero->value(), 0
				)
				, xcc_test3_DATAROW5_ITZ_T(test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t, "var4"
					, refp_failReport, intfs->INTF_STATICSTR
					, intfs->INTF_SET->strcsNull->value(), intfs->INTF_SET->strcsInitEmpty->value(), 0
				)
				, xcc_test3_DATAROW5_ITZ_T(test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t, "var5"
					, refp_failReport, intfs->INTF_STATICSTR
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[err-param.01,null self]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
			);
		}
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[err-param.02,uninit-zero-self]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[err-param.03,uninit-nonzero.self]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[err-param.04,init-empty.self]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[err-param.05,init-non-empty.self]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
		...
		if(1)
		{
			test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t rows[]=
			{
				...
				, xcc_test3_DATAROW5_ITZ_T(test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t, "var6"
					, refp_failReport, intfs->INTF_STATICSTR
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[ok-param.01,exact-match]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[ok-param.01,absolute-no-match]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[ok-param.01,partial-no-match]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
		...
		if(1)
		{
			test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t rows[]=
			{
				...
				, xcc_test3_DATAROW5_ITZ_T(test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t, "var7"
					, refp_failReport, intfs->INTF_STATICSTR
					, intfs->INTF_SET->strcsInitNonEmpty->value("abcdz.123abcz.!@#$%^&*().zyx"), intfs->INTF_SET->strcsInitNonEmpty->value(".zyx"), 0
				)
				, xcc_test3_DATAROW5_ITZ_T(test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t, "var8"
					, refp_failReport, intfs->INTF_STATICSTR
					, intfs->INTF_SET->strcsInitNonEmpty->value("ABCDZ.123ABCZ.!@#$%^&*().zyx"), intfs->INTF_SET->strcsInitNonEmpty->value(".zy1"), 0
				)
				, xcc_test3_DATAROW5_ITZ_T(test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t, "var9"
					, refp_failReport, intfs->INTF_STATICSTR
					, intfs->INTF_SET->strcsInitNonEmpty->value("ABCDZ.123ABCZ.!@#$%^&*().zyx"), intfs->INTF_SET->strcsInitNonEmpty->value("ABCDZ."), 1
				)
				, xcc_test3_DATAROW5_ITZ_T(test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t, "var10"
					, refp_failReport, intfs->INTF_STATICSTR
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[ok-param.112.case-sensitive-match-of-substring-edge-cases]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
		...
		if(1)
		{
			test_ifStartsWithCstr_againstItself_expectRetv_paramRow_t rows[]=
			{
				  xcc_test3_DATAROW4_ITZ_T(test_ifStartsWithCstr_againstItself_expectRetv_paramRow_t, "var1"
					, refp_failReport, intfs->INTF_STATICSTR
					, intfs->INTF_SET->strcsUninitZero->value(), 0
				)
				, xcc_test3_DATAROW4_ITZ_T(test_ifStartsWithCstr_againstItself_expectRetv_paramRow_t, "var2"
					, refp_failReport, intfs->INTF_STATICSTR
			...
			xcc_test3_case_forDataRow4(
				  "ifStartsWithCstr-[err-param.01,self-against-self]"
				, "TODO"
				, test_ifStartsWithCstr_againstItself_expectRetv_paramRow_t
				, test_ifStartsWithCstr_againstItself_expectRetv
				, rows
			);
		}
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow4(
				  "ifStartsWithCstr-[ok-param.01,self-against-self]"
				, "TODO"
				, test_ifStartsWithCstr_againstItself_expectRetv_paramRow_t
				, test_ifStartsWithCstr_againstItself_expectRetv
				, rows
...
template<typename TPL_STROBJ>
class subtest_StartsWithCstr_CaseSensitive_tplt: public subtest_ifStartsWithCstr_tplt<TPL_STROBJ>
{
	/* --- --- --- --- */
	/* --- --- --- --- */
	/* --- --- --- --- */
	
	using typename subtest_ifStartsWithCstr_tplt<TPL_STROBJ>::test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t;
	using subtest_ifStartsWithCstr_tplt<TPL_STROBJ>::intfs;
	using subtest_ifStartsWithCstr_tplt<TPL_STROBJ>::test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv;
	
	public: subtest_StartsWithCstr_CaseSensitive_tplt(test_xcStringS_testStaticStr_intfs_tpl<TPL_STROBJ>* ref_intfs): subtest_ifStartsWithCstr_tplt <TPL_STROBJ>(ref_intfs)
	{
	}
	...
	public: int perform(xcc_test2_param_list)
	{
		...
		x+=this->test_ifStartsWithCstr_ANYCASE(xcc_test2_param_list_forward);
		x+=this->test_ifStartsWithCstr_okParamsMatchCaseSensitive(xcc_test2_param_list_forward);
	...
	public: int test_ifStartsWithCstr_okParamsMatchCaseSensitive(xcc_test2_param_list)
	{
		xcc_test2_scope("[CSTRD]-[ifStartsWithCstr-matchCaseSensitive]");
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[ok-param.110.case-sensitive-match-of-entire-string]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[ok-param.111.case-sensitive-match-of-substring]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
...
template<typename TPL_STROBJ>
class subtest_StartsWithCstr_CaseInSensitive_tplt: public subtest_ifStartsWithCstr_tplt<TPL_STROBJ>
{
	/* --- --- --- --- */
	/* --- --- --- --- */
	/* --- --- --- --- */
	...
	public: subtest_StartsWithCstr_CaseInSensitive_tplt(test_xcStringS_testStaticStr_intfs_tpl<TPL_STROBJ>* ref_intfs): subtest_ifStartsWithCstr_tplt<TPL_STROBJ>(ref_intfs)
	{
	}
	...
	public: int perform(xcc_test2_param_list)
	{
		...
		x+=this->test_ifStartsWithCstr_ANYCASE(xcc_test2_param_list_forward);
		x+=this->test_ifStartsWithCstr_okParamsMatchCaseInsensitive(xcc_test2_param_list_forward);
	...
	public: int test_ifStartsWithCstr_okParamsMatchCaseInsensitive(xcc_test2_param_list)
	{
		xcc_test2_scope("[CSTRD]-[ifStartsWithCstr-matchCaseInsensitive]");
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[ok-param.10110.case-insensitive-match-of-entire-string]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow5(
				  "ifStartsWithCstr-[ok-param.10111.case-insensitive-match-of-substring]"
				, "TODO-01"
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv_paramRow_t
				, test_ifStartsWithCstr_ANYCASE_paramsError_expectRetv
				, rows
