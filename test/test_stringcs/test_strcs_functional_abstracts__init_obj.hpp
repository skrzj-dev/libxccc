...
#ifndef _TEST_STRINGCS_ABSTRACTS_INIT_OBJ_HPP_
#define _TEST_STRINGCS_ABSTRACTS_INIT_OBJ_HPP_
/* --- */
...
class subtest_fnInitObj_anyMutable_tplt: public test_xcStringS_testStaticStr_sub_I<TPL_STROBJ>
{
	protected: test_xcStringS_testStaticStr_intfs_tpl<TPL_STROBJ>* intfs;
	
	public: subtest_fnInitObj_anyMutable_tplt(test_xcStringS_testStaticStr_intfs_tpl<TPL_STROBJ>* ref_intfs)
	{
	...
	)
	{
		...
		do
		{
			...
			if(1)
			{
				...
				xcc_test2_expect( 0 != strIntf->init_sameObj(ptr_self_state->refp_obj_operational, ptr_param_state->refp_obj_operational) );
	...
	)
	{
		...
		do
		{
			...
			if(1)
			{
				...
				xcc_test2_expect( 0 == result.intf->verifyState(*failInfo, ptr_self_state, result.value) );
	...
	protected: int test_fnInitObj_anyMutable(xcc_test2_param_list)
	{
		...
		if(1)
		{
			...
			init_paramsError_expectError_paramRow_t rows[]=
			{
				...
				, xcc_test3_DATAROW4_ITZ_T(init_paramsError_expectError_paramRow_t, "var4", xcc_test2_case_referp_customFailInfo(), intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsNull->value(), intfs->INTF_SET->strcsInitEmpty->value() 
				)
				, xcc_test3_DATAROW4_ITZ_T(init_paramsError_expectError_paramRow_t, "var5", xcc_test2_case_referp_customFailInfo(), intfs->INTF_STATICSTR, 
			...
			xcc_test3_case_forDataRow4(
				  "init-deinit[err-param.01,null self]"
		...
		if(1)
		{
			...
			init_paramsError_expectError_paramRow_t rows[]=
			{
				...
				, xcc_test3_DATAROW4_ITZ_T(init_paramsError_expectError_paramRow_t, "var2", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsUninitZero->value(), intfs->INTF_SET->strcsUninitZero->value() 
				)
				, xcc_test3_DATAROW4_ITZ_T(init_paramsError_expectError_paramRow_t, "var3", refp_failReport, intfs->INTF_STATICSTR, 
			...
			xcc_test3_case_forDataRow4(
				  "init-deinit[err-param.02, uninit self]"
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow4(
				  "init-deinit[err-param.03, uninit self]"
				, "ERROR-OTHER-PARAM-NULL-OR-UNINIT"
				, init_paramsError_expectError_paramRow_t
				, init_paramsError_expectError
				, rows
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow4(
				  "init-deinit[err-param.03, init empty self]"
				, "ERROR-OTHER-PARAM-NULL-OR-UNINIT"
				, init_paramsError_expectError_paramRow_t
				, init_paramsError_expectError
				, rows
		...
		if(1)
		{
			...
			xcc_test3_case_forDataRow4(
				  "init-deinit[err-param.04, init nonempty self]"
				, "ERROR-OTHER-PARAM-NULL-OR-UNINIT"
				, init_paramsError_expectError_paramRow_t
				, init_paramsError_expectError
				, rows
		...
		if(1)
		{
			...
			init_paramsError_expectResultOk_paramRow_t rows[]=
			{
				  xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var1", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsUninitZero->value(), intfs->INTF_SET->strcsInitEmpty->value(), intfs->INTF_SET->strcsInitEmpty->value() 
				)
				, xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var2", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsUninitZero->value(), intfs->INTF_SET->strcsInitNonEmpty->value("1"), intfs->INTF_SET->strcsInitNonEmpty->value("1") 
				)
				, xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var3", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsUninitZero->value(), intfs->INTF_SET->strcsInitNonEmpty->value("abcdegh12345"), intfs->INTF_SET->strcsInitNonEmpty->value("abcdegh12345") 
				)
				, xcc_test3_DATAROWX_ITZ_TERM()
			};
			
			xcc_test3_case_forDataRow5(
				  "init-deinit[ok-param.01, uninit zero self]"
		...
		if(1)
		{
			...
			{
				  xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var1", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsUninitNonZero->value(), intfs->INTF_SET->strcsInitEmpty->value(), intfs->INTF_SET->strcsInitEmpty->value() 
				)
				, xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var2", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsUninitNonZero->value(), intfs->INTF_SET->strcsInitNonEmpty->value("1"), intfs->INTF_SET->strcsInitNonEmpty->value("1") 
				)
				, xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var3", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsUninitNonZero->value(), intfs->INTF_SET->strcsInitNonEmpty->value("abcdegh12345"), intfs->INTF_SET->strcsInitNonEmpty->value("abcdegh12345") 
				)
				, xcc_test3_DATAROWX_ITZ_TERM()
			};
			
			xcc_test3_case_forDataRow5(
				  "init-deinit[ok-param.02, uninit nonzero self]"
				, "INIT-OK-OTHER-PARAM-ANY-INIT-FROM-ANY-UNINIT"
				, init_paramsError_expectResultOk_paramRow_t
				, init_paramsError_expectResultOk
				, rows
...
#		if 0
		...
		if(1)
		{
			...
			{
				  xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var1", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsInitEmpty->value(), intfs->INTF_SET->strcsInitEmpty->value(), intfs->INTF_SET->strcsInitEmpty->value()
				)
				, xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var2", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsInitEmpty->value(), intfs->INTF_SET->strcsInitNonEmpty->value("1"), intfs->INTF_SET->strcsInitNonEmpty->value("1")
				)
				, xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var3", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsInitEmpty->value(), intfs->INTF_SET->strcsInitNonEmpty->value("abcdegh12345"), intfs->INTF_SET->strcsInitNonEmpty->value("abcdegh12345")
				)
				, xcc_test3_DATAROWX_ITZ_TERM()
			};
			
			xcc_test3_case_forDataRow5(
				  "init-deinit[ok-param.03, init empty self]"
				, "INIT-ERROR-IF-ALREADY-INITIALIZED"
				, init_paramsError_expectResultOk_paramRow_t
				, init_paramsError_expectResultError
				, rows
			);
		}
		...
		if(1)
		{
			...
			{
				  xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var1", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsInitNonEmpty->value("qwertyuiop12345"), intfs->INTF_SET->strcsInitEmpty->value(), intfs->INTF_SET->strcsInitEmpty->value()
				)
				, xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var2", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsInitNonEmpty->value("qwertyuiop12345"), intfs->INTF_SET->strcsInitNonEmpty->value("1"), intfs->INTF_SET->strcsInitNonEmpty->value("1")
				)
				, xcc_test3_DATAROW5_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var3", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsInitNonEmpty->value("qwertyuiop12345"), intfs->INTF_SET->strcsInitNonEmpty->value("abcdegh12345"), intfs->INTF_SET->strcsInitNonEmpty->value("abcdegh12345")
				)
				, xcc_test3_DATAROWX_ITZ_TERM()
			};
			
			xcc_test3_case_forDataRow5(
				  "init-deinit[ok-param.04, init nonempty self]"
				, "INIT-ERROR-IF-ALREADY-INITIALIZED"
				, init_paramsError_expectResultOk_paramRow_t
				, init_paramsError_expectResultOk
				, rows
...
template<typename TPL_STROBJ>
class subtest_fnInitObj_Immutable_tplt: public subtest_fnInitObj_anyMutable_tplt<TPL_STROBJ>
{
	/* --- --- --- --- */
	/* --- --- --- --- */
	/* --- --- --- --- */
	
	using typename subtest_fnInitObj_anyMutable_tplt<TPL_STROBJ>::init_paramsError_expectError_paramRow_t;
	using subtest_fnInitObj_anyMutable_tplt<TPL_STROBJ>::init_paramsError_expectError;
	using typename subtest_fnInitObj_anyMutable_tplt<TPL_STROBJ>::init_paramsError_expectResultOk_paramRow_t;
	using subtest_fnInitObj_anyMutable_tplt<TPL_STROBJ>::init_paramsError_expectResultOk;
	using subtest_fnInitObj_anyMutable_tplt<TPL_STROBJ>::intfs;
	using subtest_fnInitObj_anyMutable_tplt<TPL_STROBJ>::test_fnInitObj_anyMutable;

	public: subtest_fnInitObj_Immutable_tplt(test_xcStringS_testStaticStr_intfs_tpl<TPL_STROBJ>* ref_intfs)
		: subtest_fnInitObj_anyMutable_tplt<TPL_STROBJ>(ref_intfs)
	{
	}
	...
	public: int perform(xcc_test2_param_list)
	{
		...
		retv+=this->test_fnInitObj_anyMutable(xcc_test2_param_list_forward);
		retv+=this->test_fnInitObj_Mutable(xcc_test2_param_list_forward);
	...
	protected: int test_fnInitObj_Mutable(xcc_test2_param_list)
	{
		xcc_test2_scope("[CSTRD]-[init/deinit/raii]");
	...
	if(1)
		{
			...
			xcc_test3_case_forDataRow4(
				  "init-deinit[error-error.03, init empty self]"
				, "INIT-ERROR-IF-ALREADY-INITIALIZED"
				, init_paramsError_expectError_paramRow_t
				, init_paramsError_expectError
				, rows
		...
		if(1)
		{
			...
			init_paramsError_expectError_paramRow_t rows[]=
			{
				...
				, xcc_test3_DATAROW4_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var2", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsInitNonEmpty->value("qwertyuiop12345"), intfs->INTF_SET->strcsInitNonEmpty->value("1")
				)
				, xcc_test3_DATAROW4_ITZ_T(init_paramsError_expectResultOk_paramRow_t, "var3", refp_failReport, intfs->INTF_STATICSTR, 
					intfs->INTF_SET->strcsInitNonEmpty->value("qwertyuiop12345"), intfs->INTF_SET->strcsInitNonEmpty->value("abcdegh12345")
				)
				, xcc_test3_DATAROWX_ITZ_TERM()
			};
			
			xcc_test3_case_forDataRow4(
				  "init-deinit[error-param.04, init nonempty self]"
				, "INIT-ERROR-IF-ALREADY-INITIALIZED"
				, init_paramsError_expectError_paramRow_t
				, init_paramsError_expectError
				, rows
