...
#ifndef _XCC_TEST_TPL_VECTOR_API_CSEQ_U_HPP_
#define _XCC_TEST_TPL_VECTOR_API_CSEQ_U_HPP_

/* --- */
#include "abstracts_functional_any/vector_test_tpl_abstraction_api.hpp"
/* --- */

#define xcc_tplTestVector_vectorIntf__xcVectorD_u_hdr() template<typename TPL_VTYPE, typename _ARG_TPL_VITEMTYPE_, typename ARG_TPL_DEREFER>
#define xcc_tplTestVector_vectorIntf__xcVectorD_u_method(TYPE) TYPE xcc_tplTestVector_vectorIntf__xcVectorD_u<TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>::


xcc_tplTestVector_vectorIntf__xcVectorD_u_hdr()
class xcc_tplTestVector_vectorIntf__xcVectorD_u: public tplTestVector_vectorIntf<TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>
{
...
#include "_xcvector_d_api_u.incl.hpp"
