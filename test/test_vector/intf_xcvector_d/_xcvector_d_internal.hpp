...
#define testIntf_internal_xcVectorD__hdr() template<typename TPL_VTYPE, typename _ARG_TPL_VITEMTYPE_, typename ARG_TPL_DEREFER, class _TPL_LLII_>
#define testIntf_internal_xcVectorD__method(TYPE) TYPE testIntf_internal_xcVectorD<TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER, _TPL_LLII_>::

testIntf_internal_xcVectorD__hdr()
class testIntf_internal_xcVectorD
{
...
#include "_xcvector_d_internal.incl.hpp"
