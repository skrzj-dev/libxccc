...
testIntf_internal_xcVectorD__hdr()
testIntf_internal_xcVectorD__method(int) verifyInternalState_itemsNumbers(TPL_VTYPE* refp_self, const int expected_capacity, const int expected_length) noexcept
{
...
testIntf_internal_xcVectorD__hdr()
testIntf_internal_xcVectorD__method(int) verifyInternalState_itemsIntegrity(TPL_VTYPE* refp_self, const int expected_capacity, const int expected_length) noexcept
{
...
testIntf_internal_xcVectorD__hdr()
testIntf_internal_xcVectorD__method(int)  verifyInternalState_itemsValues(TPL_VTYPE* refp_self, const int expected_capacity, const int expected_length, std::vector<_ARG_TPL_VITEMTYPE_>& arg_refp_expected_item_order) noexcept
{
...
testIntf_internal_xcVectorD__hdr()
testIntf_internal_xcVectorD__method(int)  verifyInternalState_2vectors_same(TPL_VTYPE* refp_self, const TPL_VTYPE* refp_2nd) noexcept
{
	size_t n=0;
	xcc_test2_scope_disconnected();
...
testIntf_internal_xcVectorD__hdr()
testIntf_internal_xcVectorD__method(int) hack_forceSmallerCapacity(TPL_VTYPE* refp_self,  const size_t expected_static_capacity) noexcept
{
	xcc_err_decl();
