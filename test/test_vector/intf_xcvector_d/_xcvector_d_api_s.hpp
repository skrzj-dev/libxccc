...
#ifndef _XCC_TEST_TPL_VECTOR_API_CSEQ_S_HPP_
#define _XCC_TEST_TPL_VECTOR_API_CSEQ_S_HPP_
...
class intf_api_s: public tplTestVector_vectorIntf<TPL_VTYPE, TPL_ITEMTYPE, TPL_DEREFER_T>
{
	...
	public: int derefer_validate_integrity(TPL_VTYPE* refp_self, TPL_DEREFER_T* refp_tpl_deref) noexcept
	{
