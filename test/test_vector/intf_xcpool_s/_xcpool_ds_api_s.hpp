...
#define xcc_tplTestVector_vectorIntf__xcPoolDS_s_hdr() template<typename TPL_VTYPE, typename _ARG_TPL_VITEMTYPE_, typename ARG_TPL_DEREFER>
#define xcc_tplTestVector_vectorIntf__xcPoolDS_s_m(TYPE) TYPE xcc_tplTestVector_vectorIntf__xcPoolDS_s <TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>::


xcc_tplTestVector_vectorIntf__xcPoolDS_s_hdr()
class xcc_tplTestVector_vectorIntf__xcPoolDS_s: public tplTestVector_vectorIntf<TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>
{
...
#include "_xcpool_ds_api_s.incl.hpp"
