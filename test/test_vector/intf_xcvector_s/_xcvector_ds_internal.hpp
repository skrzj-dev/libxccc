...
#define testIntf_internal_xcVectorDS__method(TYPE) TYPE testIntf_internal_xcVectorDS_intf<TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER, _TPL_LLII_>::

testIntf_internal_xcVectorDS__hdr()
class testIntf_internal_xcVectorDS_intf
{
...
#include "_xcvector_ds_internal.incl.hpp"
