...
#define xcc_tplTestVector_vectorIntf__xcVectorDS_u_hdr() template<typename TPL_VTYPE, typename _ARG_TPL_VITEMTYPE_, typename ARG_TPL_DEREFER>
#define xcc_tplTestVector_vectorIntf__xcVectorDS_u_m(TYPE) TYPE xcc_tplTestVector_vectorIntf__xcVectorDS_u <TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>::


xcc_tplTestVector_vectorIntf__xcVectorDS_u_hdr()
class xcc_tplTestVector_vectorIntf__xcVectorDS_u: public tplTestVector_vectorIntf<TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>
{
...
#include "_xcvector_ds_api_u.incl.hpp"
