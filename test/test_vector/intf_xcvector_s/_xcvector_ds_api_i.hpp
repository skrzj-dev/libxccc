...
#define xcc_tplTestVector_vectorIntf__xcVectorDS_i_hdr() template<typename TPL_VTYPE, typename _ARG_TPL_VITEMTYPE_, typename ARG_TPL_DEREFER>
#define xcc_tplTestVector_vectorIntf__xcVectorDS_i_m(TYPE) TYPE xcc_tplTestVector_vectorIntf__xcVectorDS_i <TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>::

xcc_tplTestVector_vectorIntf__xcVectorDS_i_hdr()
class xcc_tplTestVector_vectorIntf__xcVectorDS_i: public tplTestVector_vectorIntf<TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>
{
...
#include "intf_xcvector_s/_xcvector_ds_api_i.incl.hpp"
