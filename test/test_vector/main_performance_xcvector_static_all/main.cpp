...
/* --- */
#include "implement_performance_xcvector_s/test_tpl_main_add___xcvector_ds.hpp"
...
int main(int argc, char **argv)
{
	...
	try
	{
		if(1)
		{
			if(0!=testVectorPerformance_xcVectorDS::test_performance_add(&result_add) ) {
				xcc_err_term_unmg();
			}
		}
		if(1)
		...
		result_add.print_summary_toFilename("./xcvector_s_add.txt");
