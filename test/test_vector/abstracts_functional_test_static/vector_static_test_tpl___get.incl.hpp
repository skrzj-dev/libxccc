...
xcc_tplTestVector_static_method(int) test_get(xcc_test2_param_list) noexcept
{
	xcc_test2_scope("");
	...
	do
	{
		...
		xcc_test2_case("GET-1.01.03-[initialized full];[expect invalid results when referring to INVALID IDX, OOB IDX];");
		...
		if(1)
		{
			xcc_test2_case_step_annotate("verify INVALID IDX [< 0]: ");
			
			if(1)
			{
				const int test_invalid_idx=-1;
				TPL_ITEM_TYPE* result_get_ref=NULL;
				TPL_ITEM_TYPE result_get_val_cp;
				TPL_ITEM_TYPE* result_get_direct_ptr=NULL;
				
				xcc_test2_expect( 0 != vector_I.get_idx_cp(vector_ref, test_invalid_idx, &result_get_val_cp) );
				
				result_get_ref=vector_I.get_idx_refp(vector_ref, test_invalid_idx);
				xcc_test2_expect(NULL==result_get_ref);
		...
		if(1)
		{
			xcc_test2_case_step_annotate("verify INVALID IDX [MAX]: ");
			
			if(1)
			{
				const int test_invalid_idx=INT_MAX;
				TPL_ITEM_TYPE* result_get_ref=NULL;
				TPL_ITEM_TYPE result_get_val_cp;
				TPL_ITEM_TYPE* result_get_direct_ptr=NULL;
		...
		if(1)
		{
			xcc_test2_case_step_annotate("verify INVALID IDX [OOB idx == length]: ");
			
			if(1)
			{
				const int test_invalid_idx=8;
				TPL_ITEM_TYPE* result_get_ref=NULL;
				TPL_ITEM_TYPE result_get_val_cp;
				TPL_ITEM_TYPE* result_get_direct_ptr=NULL;
		...
		if(1)
		{
			xcc_test2_case_step_annotate("verify INVALID IDX [OOB idx == length+1]: ");
			
			if(1)
			{
				const int test_invalid_idx=8+1;
				TPL_ITEM_TYPE* result_get_ref=NULL;
				TPL_ITEM_TYPE result_get_val_cp;
				TPL_ITEM_TYPE* result_get_direct_ptr=NULL;
		...
		if(1)
		{
			xcc_test2_case_step_annotate("verify INVALID IDX [OOB big]: ");
			
			if(1)
			{
				const int test_invalid_idx=65535;
				TPL_ITEM_TYPE* result_get_ref=NULL;
				TPL_ITEM_TYPE result_get_val_cp;
				TPL_ITEM_TYPE* result_get_direct_ptr=NULL;
