...
xcc_tplTestVector_static_method(int) test_raii_alloc_init(xcc_test2_param_list) noexcept
{
	xcc_test2_scope("");
...
xcc_tplTestVector_static_hdr()
xcc_tplTestVector_static_method(int) test_raii_dealloc(xcc_test2_param_list) noexcept
{
	xcc_test2_scope("");
