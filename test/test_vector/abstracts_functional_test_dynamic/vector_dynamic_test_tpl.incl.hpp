...
#include "vector_dynamic_test_tpl___internal_hlp.hpp"
/* --- */

#include "vector_dynamic_test_tpl___derefer.incl.hpp"
#include "vector_dynamic_test_tpl___init_deinit.incl.hpp"
#include "vector_dynamic_test_tpl___push.incl.hpp"
#include "vector_dynamic_test_tpl___pop.incl.hpp"
#include "vector_dynamic_test_tpl___insert.incl.hpp"
#include "vector_dynamic_test_tpl___remove.incl.hpp"
#include "vector_dynamic_test_tpl___get.incl.hpp"
#include "vector_dynamic_test_tpl___set.incl.hpp"
#include "vector_dynamic_test_tpl___alloc_dealloc.incl.hpp"
#include "vector_dynamic_test_tpl___copyfrom.incl.hpp"
...
xcc_tplTestVector_dynamic_method(int) TMP_TEST_INTERNAL_02( 
...
xcc_tplTestVector_dynamic_hdr()
xcc_tplTestVector_dynamic_method(int) TMP_TEST_INTERNAL_02_uninitZero(
	  xcc_test2_failureDetails_t& failInfo
	, TPL_VTYPE* vector_obj_ref
	, const size_t expected_length
	, std::vector<TPL_ITEM_TYPE> expected_items ) noexcept
...
xcc_tplTestVector_dynamic_hdr()
xcc_tplTestVector_dynamic_method(int) perform_test_main(xcc_test2_param_list) noexcept
{
	xcc_test2_scope("DYNAMIC-VECTOR-TEST-ALL");
