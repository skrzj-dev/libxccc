...
xcc_tplTestVector_dynamic_method(int) test_init(xcc_test2_param_list) noexcept
{
	xcc_test2_scope("");
...
xcc_tplTestVector_dynamic_hdr()
xcc_tplTestVector_dynamic_method(int) test_deinit(xcc_test2_param_list) noexcept
{
	xcc_test2_scope("");
