...
xcc_tplTestVector_dynamic_method(int) test_copyFrom_errors(xcc_test2_param_list) noexcept
{
	xcc_test2_scope("");
...
xcc_tplTestVector_dynamic_hdr()
xcc_tplTestVector_dynamic_method(int) test_copyFrom_ok(xcc_test2_param_list) noexcept
{
...
xcc_tplTestVector_dynamic_hdr()
xcc_tplTestVector_dynamic_method(int) test_copyFrom_all(xcc_test2_param_list) noexcept
{
