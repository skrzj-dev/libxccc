...
xcc_tplTestVector_dynamic_method(int) test_push(xcc_test2_param_list) noexcept
{
	xcc_test2_scope("");
	...
	do
	{
		...
		xcc_test2_case("PUSH-0.01-[expect error;all params value NULL;]");
	...
	do
	{
		...
		xcc_test2_case("PUSH-0.02-[expect error;all params ptr NULL;]");
	...
	do
	{
		...
		xcc_test2_case("PUSH-0.03-[expect error;self value NULL;]");
	...
	do
	{
		...
		xcc_test2_case("PUSH-0.04-[expect error;self ptr NULL;]");
	...
	do
	{
		...
		xcc_test2_case("PUSH-0.04-[expect error;item value NULL;]");
	...
	do
	{
		...
		xcc_test2_case("PUSH-0.04-[expect error;item ptr NULL;]");
	...
	do
	{
		...
		xcc_test2_case("PUSH-1.00-[expect ok;]");
	...
	do
	{
		...
		xcc_test2_case("PUSH-1.07-[expect ok;]");
	...
	do
	{
		...
		xcc_test2_case("PUSH-1.08-[expect ok;]");
	...
	do
	{
		...
		xcc_test2_case("PUSH-1.01.01-[expect ok;]");
	...
	do
	{
		...
		if(1)
		{
			...
			if(1) {
				const size_t expected_length=15;
				xcc_test2_expect( 0 == TMP_TEST_INTERNAL_02( xcc_test2_case_refer_customFailInfo(),  
						  vector_ref
						, expected_length
						, vector_I.DIAG_get_expected_capacity_for_length(expected_length)
	...
	do
	{
		...
		if(1)
		{
			...
			if(1) {
				const size_t expected_length=17;
				xcc_test2_expect( 0 == TMP_TEST_INTERNAL_02( xcc_test2_case_refer_customFailInfo(),  
						  vector_ref
						, expected_length
						, vector_I.DIAG_get_expected_capacity_for_length(expected_length)
