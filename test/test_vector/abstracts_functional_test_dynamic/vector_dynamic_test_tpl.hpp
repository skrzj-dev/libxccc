...
#ifndef _XCC_VECTORTESTTPL_HPP_
#define _XCC_VECTORTESTTPL_HPP_
...
#define xcc_tplTestVector_dynamic_hdr() template<typename TPL_VTYPE, typename _TPL_DEREFER_TYPE_, typename TPL_ITEM_TYPE, class _TPL_INTF_, class _TPL_INTF_INTERNAL_, class _TPL_LLII_ >
#define xcc_tplTestVector_dynamic_method(_FNTYPE_) _FNTYPE_ xcc_tplTestVector_dynamic<TPL_VTYPE, _TPL_DEREFER_TYPE_, TPL_ITEM_TYPE, _TPL_INTF_, _TPL_INTF_INTERNAL_, _TPL_LLII_>::


xcc_tplTestVector_dynamic_hdr()
class xcc_tplTestVector_dynamic 
{
	...
	private: int TMP_TEST_INTERNAL_02( 
	...
	private: int TMP_TEST_INTERNAL_02_uninitZero(
		  xcc_test2_failureDetails_t& failInfo
		, TPL_VTYPE* vector_obj_ref
		, const size_t expected_length
		, std::vector<TPL_ITEM_TYPE> expected_items
...
#include "vector_dynamic_test_tpl.incl.hpp"
