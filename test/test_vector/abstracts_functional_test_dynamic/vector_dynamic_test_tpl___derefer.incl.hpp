...
xcc_tplTestVector_dynamic_method(int) test_derefer_00(xcc_test2_param_list) noexcept
{
	xcc_test2_scope("");
...
xcc_tplTestVector_dynamic_hdr()
xcc_tplTestVector_dynamic_method(int) test_derefer_01(xcc_test2_param_list) noexcept
{
	xcc_test2_scope("");
