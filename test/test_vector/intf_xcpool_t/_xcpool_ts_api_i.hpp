...
#ifndef _XCC_TEST_TPL_VECTOR_API_CPOOL_TS_I_HPP_
#define _XCC_TEST_TPL_VECTOR_API_CPOOL_TS_I_HPP_
...
#include "xc/tcpool_t/xc_tcpool_t_api_i.h"
/* --- */
...
class intf_api_i: public tplTestVector_vectorIntf<TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>
{
	...
	{
		return xcPoolTS_dummyItem_t_I.init(
			  refp_self
		);
	}
	...
	{
		return xcPoolTS_dummyItem_t_I.deinit(
			  refp_self
		);
	}
	...
	public: int push(TPL_VTYPE* refp_self, const _ARG_TPL_VITEMTYPE_* refp_target) noexcept
	{
		...
		return xcPoolTS_dummyItem_t_I.push(
			  refp_self
			, refp_target
		);
	...
	{
		return xcPoolTS_dummyItem_t_I.pop(
			  refp_self
		);
	...
	{
		return xcPoolTS_dummyItem_t_I.remove_idx(
			  refp_self
			, idx
		);
	}
	...
	{
		return xcPoolTS_dummyItem_t_I.insert(
			  refp_self
			, idx
			, refp_target
		);
	...
	{
		return xcPoolTS_dummyItem_t_I.set_idx(
			  refp_self
			, idx
			, refp_target
		);
	...
	{
		return xcPoolTS_dummyItem_t_I.item_cp(
			  refp_self
			, idx
			, refp_target
		);
	...
	{
		return xcPoolTS_dummyItem_t_I.item_refp(
			  refp_self
			, idx
		);
	}
	...
	{
		return xcPoolTS_dummyItem_t_I.get_length(
			  refp_self
		);
	}
	...
	{
		return xcPoolTS_dummyItem_t_I.get_capacity(
			  refp_self
		);
	}
	...
	{
		return xcPoolTS_dummyItem_t_I.alloc_init(
	...
	public: int dealloc(TPL_VTYPE* refp_self) noexcept
	{
		...
		return xcPoolTS_dummyItem_t_I.dealloc(
			  refp_self
		);
	...
	{
		return xcPoolTS_dummyItem_t_I.assign_from(
			  refp_self
			, refp_self_src
			, result_overflow
		);
