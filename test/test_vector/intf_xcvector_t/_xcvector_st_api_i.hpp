...
#ifndef _XCC_TEST_TPL_VECTOR___CCCVECTOR_ST_API_I_HPP_
#define _XCC_TEST_TPL_VECTOR___CCCVECTOR_ST_API_I_HPP_
...
#define xcc_tplTestVector_vectorIntf__xcVectorST_i_hdr() template<typename TPL_VTYPE, typename _ARG_TPL_VITEMTYPE_, typename ARG_TPL_DEREFER>
#define xcc_tplTestVector_vectorIntf__xcVectorST_i_m(TYPE) TYPE xcc_tplTestVector_vectorIntf__xcVectorST_i <TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>::

xcc_tplTestVector_vectorIntf__xcVectorST_i_hdr()
class xcc_tplTestVector_vectorIntf__xcVectorST_i: public tplTestVector_vectorIntf<TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>
{
...
#include "_xcvector_st_api_i.incl.hpp"
