...
#define testIntf_internal_xcVectorST__hdr() template<typename TPL_VTYPE, typename _ARG_TPL_VITEMTYPE_, typename ARG_TPL_DEREFER, class _TPL_LLII_>
#define testIntf_internal_xcVectorST__method(TYPE) TYPE testIntf_internal_xcVectorST_intf<TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER, _TPL_LLII_>::
...
#include "_xcvector_st_internal.incl.hpp"
