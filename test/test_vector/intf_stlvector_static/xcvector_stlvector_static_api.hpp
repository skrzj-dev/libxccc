...
#define xcc_tplTestVector_vectorIntf__stlVector_static_hdr() template<typename TPL_VTYPE, typename _ARG_TPL_VITEMTYPE_, typename ARG_TPL_DEREFER>
#define xcc_tplTestVector_vectorIntf__stlVector_static_m(TYPE) TYPE xcc_tplTestVector_vectorIntf__stlVector_static<TPL_VTYPE, _ARG_TPL_VITEMTYPE_, ARG_TPL_DEREFER>::
...
#include "intf_stlvector_static/xcvector_stlvector_static_api.incl.hpp"
