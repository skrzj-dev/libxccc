...
#define embedd_01() \
	test_ObjReference_Refcounter<seqDS_dummyItem_t> vec_dummy_ref=test_ObjReference_Refcounter<seqDS_dummyItem_t>();\
	...
	seqDS_dummyItem_t* vec=NULL;\
	dummyItem_t tmpi={1, "x.aa.11"};\
	int dummy_idx=0;\
	xcc_test2_expect( NULL != ( vec = xc_tcVectorS_u_alloc_init(seqDS_dummyItem_t, vec, 8) ) );\
	/**/\
...
#define embedd_01_done() \
	xcc_test2_expect( 0 == xc_tcVectorS_u_dealloc(vec) );
...
static int test_push(xcc_test2_param_list)
{
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 == xc_tcVectorS_u_push( vec_dummy_ref.get_refp(), item_dummy_ref.get_refp() ) );
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 == xc_tcVectorS_s_push( vec_dummy_ref.get_refp(), item_dummy_ref.get_refp() ) );
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 == seqDS_dummyItem_t_I.push( vec_dummy_ref.get_refp(), item_dummy_ref.get_refp() ) );
...
static int test_pop(xcc_test2_param_list)
{
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 != xc_tcVectorS_u_pop( vec_dummy_ref.get_refp() ) );
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 != xc_tcVectorS_s_pop( vec_dummy_ref.get_refp() ) );
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 != seqDS_dummyItem_t_I.pop( vec_dummy_ref.get_refp() ) );
...
static int test_remove(xcc_test2_param_list)
{
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 != xc_tcVectorS_u_remove_idx( vec_dummy_ref.get_refp(), idx_dummy_ref.get_val() ) );
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 != xc_tcVectorS_s_remove_idx( vec_dummy_ref.get_refp(), idx_dummy_ref.get_val() ) );
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 != seqDS_dummyItem_t_I.remove_idx( vec_dummy_ref.get_refp(), idx_dummy_ref.get_val() ) );
...
static int test_insert(xcc_test2_param_list)
{
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 == xc_tcVectorS_u_insert( vec_dummy_ref.get_refp(), 0, item_dummy_ref.get_refp() ) );
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 == xc_tcVectorS_s_insert( vec_dummy_ref.get_refp(), 0, item_dummy_ref.get_refp() ) );
	...
	do
	{
		...
		if(1)
		{
			...
			xcc_test2_expect( 0 == seqDS_dummyItem_t_I.insert( vec_dummy_ref.get_refp(), 0, item_dummy_ref.get_refp() ) );
...
int test_paramEvaluationCnt_xcVectorDS_main(xcc_test2_param_list)
{
